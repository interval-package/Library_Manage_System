...
class Ui_CheckInfoPage(object):
    def setupUi(self, CheckInfoPage):
        ...
        self.gridLayout.addItem(spacerItem, 8, 0, 1, 8)
        ...
        self.gridLayout.addWidget(self.pushButton_4, 9, 0, 1, 3)
        ...
        self.gridLayout.addItem(spacerItem1, 1, 0, 1, 8)
    ...
    def retranslateUi(self, CheckInfoPage):
        ...
        self.pushButton_3.setText(_translate("CheckInfoPage", "Query"))
        self.pushButton_2.setText(_translate("CheckInfoPage", "Update"))
        ...
        self.pushButton_4.setText(_translate("CheckInfoPage", "Query"))

...
class Ui_BookEditPage(object):
    def setupUi(self, BookEditPage):
        ...
        self.TypeNameLine = QtWidgets.QLineEdit(self.gridLayoutWidget)
        self.TypeNameLine.setObjectName("TypeNameLine")
        self.gridLayout.addWidget(self.TypeNameLine, 6, 3, 1, 2)
        ...
        self.TypeIdLine = QtWidgets.QLineEdit(self.gridLayoutWidget)
        self.TypeIdLine.setObjectName("TypeIdLine")
        self.gridLayout.addWidget(self.TypeIdLine, 4, 3, 1, 2)
    ...
    def retranslateUi(self, BookEditPage):
        ...
        self.comboBox_2.setItemText(0, _translate("BookEditPage", "Alter info"))
        self.comboBox_2.setItemText(1, _translate("BookEditPage", "Ques"))
        ...
        self.comboBox.setItemText(0, _translate("BookEditPage", "Disp Info"))
        self.comboBox.setItemText(1, _translate("BookEditPage", "Show Detail"))
        ...
        self.label.setText(_translate("BookEditPage", "Modify info"))
        ...
        self.label_8.setText(_translate("BookEditPage", "Name"))
        self.label_7.setText(_translate("BookEditPage", "Id"))

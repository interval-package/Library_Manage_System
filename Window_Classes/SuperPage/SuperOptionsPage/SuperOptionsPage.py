...
class Ui_SuperOptionsPage(object):
    def setupUi(self, SuperOptionsPage):
        ...
        self.ChangeParamBUtton = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.ChangeParamBUtton.setObjectName("ChangeParamBUtton")
        self.gridLayout.addWidget(self.ChangeParamBUtton, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.GoBackButton, 4, 0, 1, 1)
        self.CalculateButton = QtWidgets.QPushButton(self.gridLayoutWidget)
    ...
    def retranslateUi(self, SuperOptionsPage):
        ...
        self.ChangeParamBUtton.setText(_translate("SuperOptionsPage", "Change Parameters"))
        ...
        self.CalculateButton.setText(_translate("SuperOptionsPage", "Calculate Info"))
